...
const Comments = () => {
  ...
  const fetchComments = async () => {
    try {
      const response = await axios.get("webdev-dramaku-production.up.railway.app/comments", {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      await Promise.all(idsToApprove.map(id => 
        axios.put(`webdev-dramaku-production.up.railway.app/comments/${id}`, { status: true })
      ));
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete("webdev-dramaku-production.up.railway.app/comments", { data: { ids: idsToDelete } });
