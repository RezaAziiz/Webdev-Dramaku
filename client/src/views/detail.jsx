...
const MovieDetail = () => {
  ...
  useEffect(() => {
    const fetchGenres = async () => {
      try {
        const response = await fetch('webdev-dramaku-production.up.railway.app/api/genres');
  ...
  useEffect(() => {
    const checkWatchlist = async () => {
      if (isLoggedIn && username) {
        try {
          const response = await fetch(`webdev-dramaku-production.up.railway.app/api/watchlist/${username}`);
  ...
  useEffect(() => {
    const fetchMovieDetails = async () => {
      try {
        const response = await fetch(`webdev-dramaku-production.up.railway.app/movies/${id}`);
        if (!response.ok) {
  ...
  const handleCommentSubmit = async () => {
    ...
    try {
      const response = await axios.post(
        `webdev-dramaku-production.up.railway.app/movies/${id}/comments`,
        { commentText, rating },
        {
          headers: {
  ...
  const handleAddToWatchlist = async (movieId) => {
    ...
    try {
      const response = await fetch('webdev-dramaku-production.up.railway.app/api/watchlist', {
        method: 'POST',
        headers: {
